...
INSERT INTO students (id, class_id, full_name, student_id, created_at) VALUES
('20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'Emma Wilson', 'STU001', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'Liam Brown', 'STU002', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', 'Olivia Garcia', 'STU003', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', 'Noah Martinez', 'STU004', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', 'Ava Rodriguez', 'STU005', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', 'Ethan Davis', 'STU006', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', 'Sophia Lopez', 'STU007', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000001', 'Mason Gonzalez', 'STU008', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', 'Isabella Wilson', 'STU009', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000001', 'James Anderson', 'STU010', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000011', '10000000-0000-0000-0000-000000000001', 'Mia Thomas', 'STU011', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000012', '10000000-0000-0000-0000-000000000001', 'Benjamin Taylor', 'STU012', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000013', '10000000-0000-0000-0000-000000000001', 'Charlotte Moore', 'STU013', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000014', '10000000-0000-0000-0000-000000000001', 'Lucas Jackson', 'STU014', NOW() - INTERVAL '4 months'),
('20000000-0000-0000-0000-000000000015', '10000000-0000-0000-0000-000000000001', 'Amelia Martin', 'STU015', NOW() - INTERVAL '4 months');

-- Insert students for CS201
INSERT INTO students (id, class_id, full_name, student_id, created_at) VALUES
('20000000-0000-0000-0000-000000000016', '10000000-0000-0000-0000-000000000002', 'Oliver Lee', 'STU016', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000017', '10000000-0000-0000-0000-000000000002', 'Harper Perez', 'STU017', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000018', '10000000-0000-0000-0000-000000000002', 'Elijah White', 'STU018', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000019', '10000000-0000-0000-0000-000000000002', 'Evelyn Harris', 'STU019', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000020', '10000000-0000-0000-0000-000000000002', 'William Sanchez', 'STU020', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000021', '10000000-0000-0000-0000-000000000002', 'Abigail Clark', 'STU021', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000022', '10000000-0000-0000-0000-000000000002', 'Alexander Ramirez', 'STU022', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000023', '10000000-0000-0000-0000-000000000002', 'Emily Lewis', 'STU023', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000024', '10000000-0000-0000-0000-000000000002', 'Daniel Robinson', 'STU024', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000025', '10000000-0000-0000-0000-000000000002', 'Elizabeth Walker', 'STU025', NOW() - INTERVAL '3 months');

-- Insert students for Calculus I
INSERT INTO students (id, class_id, full_name, student_id, created_at) VALUES
('20000000-0000-0000-0000-000000000026', '10000000-0000-0000-0000-000000000003', 'Matthew Young', 'STU026', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000027', '10000000-0000-0000-0000-000000000003', 'Sofia Allen', 'STU027', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000028', '10000000-0000-0000-0000-000000000003', 'David King', 'STU028', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000029', '10000000-0000-0000-0000-000000000003', 'Avery Wright', 'STU029', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000030', '10000000-0000-0000-0000-000000000003', 'Joseph Scott', 'STU030', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000031', '10000000-0000-0000-0000-000000000003', 'Ella Green', 'STU031', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000032', '10000000-0000-0000-0000-000000000003', 'Samuel Baker', 'STU032', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000033', '10000000-0000-0000-0000-000000000003', 'Scarlett Adams', 'STU033', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000034', '10000000-0000-0000-0000-000000000003', 'Henry Nelson', 'STU034', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000035', '10000000-0000-0000-0000-000000000003', 'Victoria Carter', 'STU035', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000036', '10000000-0000-0000-0000-000000000003', 'Sebastian Mitchell', 'STU036', NOW() - INTERVAL '3 months'),
('20000000-0000-0000-0000-000000000037', '10000000-0000-0000-0000-000000000003', 'Grace Perez', 'STU037', NOW() - INTERVAL '3 months');

-- Insert students for English Composition
INSERT INTO students (id, class_id, full_name, student_id, created_at) VALUES
('20000000-0000-0000-0000-000000000038', '10000000-0000-0000-0000-000000000004', 'Jackson Roberts', 'STU038', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000039', '10000000-0000-0000-0000-000000000004', 'Chloe Turner', 'STU039', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000040', '10000000-0000-0000-0000-000000000004', 'Jack Phillips', 'STU040', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000041', '10000000-0000-0000-0000-000000000004', 'Lily Campbell', 'STU041', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000042', '10000000-0000-0000-0000-000000000004', 'Owen Parker', 'STU042', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000043', '10000000-0000-0000-0000-000000000004', 'Zoe Evans', 'STU043', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000044', '10000000-0000-0000-0000-000000000004', 'Luke Edwards', 'STU044', NOW() - INTERVAL '2 months'),
('20000000-0000-0000-0000-000000000045', '10000000-0000-0000-0000-000000000004', 'Hannah Collins', 'STU045', NOW() - INTERVAL '2 months');
