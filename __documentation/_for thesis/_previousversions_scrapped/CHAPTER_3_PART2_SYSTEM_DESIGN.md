...
Section 3.5 has provided a comprehensive technical overview of the Engagium system's design and implementation. The three-tier architecture, modular organization, and technology selections reflect contemporary best practices in web and extension development. The dual authentication system, two-table attendance model, and room-based WebSocket architecture demonstrate thoughtful solutions to the unique challenges of real-time participation tracking in online learning environments.

The documented limitations acknowledge the prototype nature of the system and areas requiring further development for production deployment. Nonetheless, the system as implemented successfully addresses the core research problem: providing instructors with automated, real-time visibility into student participation during synchronous online classes conducted via Google Meet.

The technical methodology detailed in this section complements the research methodology described in Sections 3.1–3.4, forming a complete methodological framework for both system development and empirical evaluation.

---

**[END OF CHAPTER 3 PART 2: Section 3.5]**

**Note**: This completes Chapter 3 – Methodology. Parts 1 and 2 should be combined for final thesis document preparation.
